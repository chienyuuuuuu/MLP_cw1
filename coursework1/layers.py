...
class LeakyReluLayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        outputs = np.minimum(inputs, 0.) * 0.01 + np.maximum(inputs, 0.) #remove and replace with your code
        return outputs
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        gradients = (outputs > 0) * grads_wrt_outputs + (outputs < 0) * grads_wrt_outputs * 0.01 #remove and replace with your code
        return gradients
...
class ELULayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        For inputs `x` and outputs `y` this corresponds to `y = max(0, x)`.
        """
        outputs = (np.exp(np.minimum(inputs, 0.))-1)*1 + np.maximum(inputs, 0.) #remove and replace with your code
        return outputs
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        gradients with respect to the layer inputs.
        """
        gradients = (outputs < 0) * np.exp(inputs) * grads_wrt_outputs * 1  +  (outputs > 0) * grads_wrt_outputs#remove and replace with your code
        return gradients
...
class SELULayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        For inputs `x` and outputs `y` this corresponds to `y = max(0, x)`.
        """
        outputs = (np.exp(np.minimum(inputs, 0.))-1) * 1.6733 * 1.0507 + np.maximum(inputs, 0.) * 1.0507
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        gradients with respect to the layer inputs.
        """
        gradients = (outputs < 0) * np.exp(inputs) * grads_wrt_outputs * 1.6733 * 1.0507 +  (outputs > 0) * grads_wrt_outputs * 1.0507
